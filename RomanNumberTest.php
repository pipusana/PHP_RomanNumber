...
class RomanNumberTest extends PHPUnit_Framework_TestCase
{
	 ...
	 public function test_put_number_sixhundred_shoul_be_return_DC()
	 {
	 	  $this->assertEquals('DC',$this->romannumber->convertToRomanNumber(600));
	 }

	 public function test_put_number_ninehundred_shoul_be_return_CM()
	 {
	 ...
	 public function test_put_number_fourthousand_shoul_be_return_MMMM()
	 {
